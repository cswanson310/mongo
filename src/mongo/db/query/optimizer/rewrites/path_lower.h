...
public:
    EvalPathLowering(VariableEnvironment& env) : _env(env) {}
...
public:
    EvalFilterLowering(VariableEnvironment& env) : _env(env) {}
...
class PathLowering {
public:
    PathLowering(VariableEnvironment& env) : _env(env), _project(env), _filter(env) {}
