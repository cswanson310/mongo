...
class PathFusion {
    ...
    struct CollectedInfo {
        ...
        bool isNotNothing() const {
            return type != Type::unknown && type != Type::nothing;
        }
    };
...
private:
    ...
    stdx::unordered_map<const PathSyntaxSort*, CollectedInfo> _info;
    stdx::unordered_set<const PathSyntaxSort*> _redundant;
