...
using DefinitionsMap = std::unordered_map<ProjectionName, Definition>;

struct VariableCollectorResult {
    stdx::unordered_set<const Variable*> _variables;
    ...
    stdx::unordered_set<std::string> _definedVars;
};
