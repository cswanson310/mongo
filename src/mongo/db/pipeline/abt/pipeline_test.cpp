...
TEST(ABTTranslate, MatchSortIndex) {
    ...
    ASSERT_EQ(
        ...
        "|           |   PathIdentity []\n"
        "|           Variable [scan_0]\n"
        "BinaryJoin [joinType: Inner, {rid_4}]\n"
        "|   |   Const [true]\n"
        "|   Seek [ridProjection: 'rid_4', {'<root>': 'scan_0'}, 'collection']\n"
        "|   |   BindBlock:\n"
        "|   |       [scan_0]\n"
        "|   |           Source []\n"
        "|   RefBlock: \n"
        "|       Variable [rid_4]\n"
        "IndexScan [{'<rid>': 'rid_4'}, scanDefName: 'collection', indexDefName: 'index1', "
        "intervals: {{{['Const [10]', 'Const [10]']}}}]\n"
        "    BindBlock:\n"
        "        [rid_4]\n"
        "            Source []\n",
...
TEST(ABTTranslate, Index1) {
...

    {
        ...
        ASSERT_EQ(
            ...
            "|   |   PathIdentity []\n"
            "|   Variable [scan_0]\n"
            "BinaryJoin [joinType: Inner, {rid_5}]\n"
            "|   |   Const [true]\n"
            "|   Seek [ridProjection: 'rid_5', {'<root>': 'scan_0'}, 'collection']\n"
            "|   |   BindBlock:\n"
            "|   |       [scan_0]\n"
            "|   |           Source []\n"
            "|   RefBlock: \n"
            "|       Variable [rid_5]\n"
            "IndexScan [{'<rid>': 'rid_5'}, scanDefName: 'collection', indexDefName: 'index1', "
